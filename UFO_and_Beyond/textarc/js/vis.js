...
// ------ France Code ------ //
// log a list of all names
d3.csv("data/UFOCLEAN.csv", function (data) {
  words = []
...
// REFERENCE - Harvard referencing guide for webpage with no author
// Alice's Adventures In Wonderland, viewed 10 June 2021, http://vallandingham.me/textarc/
// Word Tree, viewed 9 June 2021, https://www.jasondavies.com/wordtree/
...
d3.queue()
  .defer(d3.text, "data/UFOCLEAN-text.txt")
  .await(display);
